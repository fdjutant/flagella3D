...
pklFolder = os.path.join(this_file_dir,
                          ...
                          'Flagella-data', 'summary-PKL-10fitPoints')
...
ax0.plot(xtrack*exp3D_s,cm_specific[:,0]-cm_specific[0,0],alpha=1,c='r')   
ax0.plot(xtrack*exp3D_s,cm_specific[:,1]-cm_specific[0,1],alpha=1,c='g')   
ax0.plot(xtrack*exp3D_s,cm_specific[:,2]-cm_specific[0,2],alpha=1,c='b')   
ax0.set_xlabel(r'Time [sec]')
ax0.set_ylabel(r'Displacement [$\mu$m]')
ax0.legend([r"$x$","$y$","$z$"], ncol=3)
...
plt.rcParams.update({'font.size': 18})
xtrack = np.arange(0,len(cm[whichFiles][:,0]))
ax0.plot(xtrack*exp3D_s,disp_specific[:,0],alpha=.75,c='purple',lw=1.2)   
ax0.plot(xtrack*exp3D_s,disp_specific[:,1],alpha=.75,c='C1',lw=1.2)   
ax0.plot(xtrack*exp3D_s,disp_specific[:,2],alpha=.75,c='C2',lw=1.2)   
ax0.set_xlabel(r'Time [sec]')
...
ax0.plot(xtrack*exp3D_s,trans0,alpha=.75,c='purple',lw=1.2)   
ax0.plot(xtrack*exp3D_s,trans1,alpha=.75,c='C1',lw=1.2)   
ax0.plot(xtrack*exp3D_s,trans2,alpha=.75,c='C2',lw=1.2)   
ax0.set_xlabel(r'Time [sec]')
...
plt.rcParams.update({'font.size': 18})
xtrack = np.arange(0,len(cm[whichFiles][:,0]))
ax0.plot(xtrack*exp3D_s,disp_Ang_specific[:,0],alpha=.75,c='C1',lw=1.2)   
ax0.plot(xtrack*exp3D_s,disp_Ang_specific[:,1],alpha=.75,c='purple',lw=1.2)   
ax0.plot(xtrack*exp3D_s,disp_Ang_specific[:,2],alpha=.75,c='C2',lw=1.2)   
ax0.set_xlabel(r'Time [sec]')
...
plt.rcParams.update({'font.size': 18})
xtrack = np.arange(1,len(cm[whichFiles][:,0]))
ax0.plot(xtrack*exp3D_s,EuAng0,alpha=.75,c='C1',lw=1.2)   
ax0.plot(xtrack*exp3D_s,EuAng1,alpha=.75,c='purple',lw=1.2)   
ax0.plot(xtrack*exp3D_s,EuAng2,alpha=.75,c='C2',lw=1.2)   
ax0.set_xlabel(r'Time [sec]')
...
print('D_n1 = %.2f, D_n2 = %.2f, D_n3 = %.2f'
      %(fit_n1/(2*exp3D_s), fit_n2/(2*exp3D_s), fit_n3/(2*exp3D_s)))

plt.rcParams.update({'font.size': 18})
fig0,ax0 = plt.subplots(dpi=300, figsize=(6,5))
ax0.plot(xaxis*exp3D_s, MSD_n1,
         c='purple',marker="s",mfc='none',
         ms=5,ls='None',alpha=1)   
ax0.plot(xaxis*exp3D_s, MSD_n2,
         c='C1',marker="s",mfc='none',
         ms=5,ls='None',alpha=1)
ax0.plot(xaxis*exp3D_s, MSD_n3,
         c='C2',marker="s",mfc='none',
         ms=5,ls='None',alpha=1)
ax0.plot(xaxis*exp3D_s, fit_n1_const + fit_n1*xaxis,
         c='purple',alpha=1,label='_nolegend_')
ax0.plot(xaxis*exp3D_s,fit_n2_const + fit_n2*xaxis,
         c='C1',alpha=1,label='_nolegend_')
ax0.plot(xaxis*exp3D_s,fit_n3_const + fit_n3*xaxis,
...
print('D_R = %.2f, D_P = %.2f, D_Y = %.2f'
      %(fit_R/(2*exp3D_s), fit_P/(2*exp3D_s), fit_Y/(2*exp3D_s)))

plt.rcParams.update({'font.size': 18})
fig0,ax0 = plt.subplots(dpi=300, figsize=(6,5))
ax0.plot(xaxis*exp3D_s, MSAD_n1,
         c='purple',marker="o",mfc='none',
         ms=5,ls='None',alpha=1)   
ax0.plot(xaxis*exp3D_s, fit_R_const + fit_R*xaxis,
         c='purple',alpha=1,label='_nolegend_')
ax0.set_xlabel(r'Lag time [sec]')
...
fig0,ax0 = plt.subplots(dpi=300, figsize=(6,5))
ax0.plot(xaxis*exp3D_s, MSAD_n2,
         c='C1',marker="o",mfc='none',
         ms=5,ls='None',alpha=1)
ax0.plot(xaxis*exp3D_s, MSAD_n3,
         c='C2',marker="o",mfc='none',
         ms=5,ls='None',alpha=1)
ax0.plot(xaxis*exp3D_s,fit_P_const + fit_P*xaxis,
         c='C1',alpha=1,label='_nolegend_')
ax0.plot(xaxis*exp3D_s,fit_Y_const + fit_Y*xaxis,
         c='C2',alpha=1,label='_nolegend_')
ax0.set_xlabel(r'Lag time [sec]')
ax0.set_ylabel(r'MSAD [rad$^2$]')
ax0.set_ylim([0, 0.08])
...
kB = 1.380649e-23  # J / K
T = 273 + 25       # K
length_flagellum = np.arange(3,10,0.1)
...
# 70%(w/v) suc
vis70 = 4.5e-3     # Pa.sec (suc70(w/v) ~ 3 mPa.sec)
...
ax.errorbar(length_diff_sorted[:,0], length_diff_sorted[:,2],
...
fig, ax = plt.subplots(dpi=300, figsize=(10,7))
plt.rcParams.update({'font.size': 22})
ax.errorbar(length_diff_sorted[:,0],
...
# 50%(w/v) suc
vis50 = 3e-3     # Pa.sec (suc70(w/v) ~ 3 mPa.sec)
...
# 40%(w/v) suc
vis40 = 3e-3     # Pa.sec (suc70(w/v) ~ 3 mPa.sec)
...
fig, ax = plt.subplots(dpi=300, figsize=(10,7))
plt.rcParams.update({'font.size': 22})
ax.errorbar(length_diff_sorted[:,0], length_diff_sorted[:,6],
             xerr=length_diff_sorted[:,1], 
             marker="o", markersize=10, color='C1', linestyle="none",
             capsize=10, capthick=1.5, alpha=0.5)
ax.errorbar(length_diff_sorted[:,0], length_diff_sorted[:,7],
             xerr=length_diff_sorted[:,1], 
             marker="o", markersize=10, color='C2', linestyle="none",
             capsize=10, capthick=1.5, alpha=0.5)
