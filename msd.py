...
class theMSD:
    def __init__(self, rNlagTime, Nframes, cm, dirAng, rollAng, expTime):
    ...
    def trans_MSD(self):
        ...
        MSD_S1 = np.zeros(NlagTime) 
        MSD_S2 = np.zeros(NlagTime)
        MSD_N = np.zeros(NlagTime) 
        j = 1;
        while j < NlagTime:
            tempN = []; tempS1 =[]; tempS2 = [];  
            i = 0; T = [];
            ...
            j += 1
        return time_x, MSD_N, MSD_S1, MSD_S2
