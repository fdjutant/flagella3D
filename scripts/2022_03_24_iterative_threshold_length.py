...
for frame in range(total_frame):
    ...
    for ii in range(max_thresh_iterations):
        ...
        if ii > 0 and flagella_len_temp == thresh_size_temp:
            break
        
        # update constraint
        thresh_size_temp = flagella_len_temp
    
        # print iteration number 
        print('frame = %d, iteration = %d, # thresholded length = %.2f, threshold = %d, elapsed time = %0.2fs'
    ...
    thresh_size[frame] = flagella_len_temp
    # threshold value
