...
ax3.axhline(y = 0, color = 'k', label = 'axvline - full height')



# x-z plot
ax4.scatter(xp0[:,0][::downsample_rate],xp0[:,2][::downsample_rate],
            c='k',alpha=0.1)
ax4.plot(xm, ym_sin, 'C1')
# ax4.plot(xm, ym_sin_ref, 'gray')
ax4.set_xlabel(r'$R \cdot n_1$ [px]')
ax4.set_ylabel(r'$R \cdot m_3$ [px]')
ax4.set_ylim([-6, 6])
ax4.axvline(x = 0, color = 'k', label = 'axvline - full height')
ax4.axhline(y = 0, color = 'k', label = 'axvline - full height')
# ax4.figure.savefig('./fitting.pdf')
