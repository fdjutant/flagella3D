...
mean_n1 = [np.mean(D_trans_40[:,0]), np.mean(D_trans_50[:,0]),
           np.mean(D_trans_70[:,0])]
std_n1 =  [np.std(D_trans_40[:,0]) / np.sqrt(len(D_trans_40[:,0])),
           np.std(D_trans_50[:,0]) / np.sqrt(len(D_trans_50[:,0])),
           np.std(D_trans_70[:,0]) / np.sqrt(len(D_trans_70[:,0]))]
mean_n2 = [np.mean(D_trans_40[:,1]), np.mean(D_trans_50[:,1]),
           np.mean(D_trans_70[:,1])]
std_n2 = [np.std(D_trans_40[:,1]) / np.sqrt(len((D_trans_40[:,1]))),
          np.std(D_trans_50[:,1]) / np.sqrt(len((D_trans_50[:,1]))),
          np.std(D_trans_70[:,1]) / np.sqrt(len((D_trans_70[:,1])))]
...
sns.stripplot(data=[D_trans_40[:,0], D_trans_50[:,0], D_trans_70[:,0]],
              color="purple", alpha=0.5,
              transform=trans1, marker="o", size=10, jitter=0.08)
sns.stripplot(data=[D_trans_40[:,1], D_trans_50[:,1], D_trans_70[:,1]],
              color="C1", alpha=0.5,
              transform=trans2, marker="o", size=10, jitter=0.08)
sns.stripplot(data=[D_trans_40[:,2], D_trans_50[:,2], D_trans_70[:,2]],
              color="C2", alpha=0.5,
              transform=trans2, marker="o", size=10, jitter=0.08)
...
mean_n1 = [np.mean(D_rot_40[:,0]), np.mean(D_rot_50[:,0]),
          np.mean(D_rot_70[:,0])]
std_n1 = [np.std(D_rot_40[:,0]) / np.sqrt(len(D_rot_40[:,0])), 
          np.std(D_rot_50[:,0]) / np.sqrt(len(D_rot_50[:,0])),
          np.std(D_rot_70[:,0]) / np.sqrt(len(D_rot_70[:,0]))]
mean_n2 = [np.mean(np.mean([D_rot_40[:,1], D_rot_40[:,1]], axis=0)),
           np.mean(np.mean([D_rot_50[:,1], D_rot_50[:,1]], axis=0)),
           np.mean(np.mean([D_rot_70[:,1], D_rot_70[:,1]], axis=0))]
std_n2 = [np.std(D_rot_40[:,1]) / np.sqrt(len(D_rot_40[:,1])),
          np.std(np.mean([D_rot_50[:,1], D_rot_50[:,2]], axis=0)) / np.sqrt(len(D_rot_50[:,1])),
          np.std(np.mean([D_rot_70[:,1], D_rot_70[:,2]], axis=0)) / np.sqrt(len(D_rot_70[:,1]))]
xlabel = ["1.77", "1.96", "2.84"] 
# xlabel = ["16.67%", "18.96%", "27.01%"]
...
ax.errorbar(xlabel, mean_n2, yerr=std_n2, marker="_", markersize=50,
            color='k', linestyle="none", capsize=10)
sns.stripplot(data=[D_rot_40[:,1], D_rot_50[:,1], D_rot_70[:,1]],
              color="C1", alpha=0.5,
              marker="o", size=10, jitter=0.08)
sns.stripplot(data=[D_rot_40[:,2], D_rot_50[:,2], D_rot_70[:,2]],
              color="C2", alpha=0.5,
              marker="o", size=10, jitter=0.08)
ax.set_xticklabels(xlabel)
