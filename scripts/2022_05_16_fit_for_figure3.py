...
vis_measured = np.array([1.77,2.41,3.43])
vis_range = np.linspace(1,5,100)
...
D_theory = np.mean(data_exclusion_50[:,5]) * (vis_measured[1]/vis_range)
...
sem_n2 = [sem(np.mean([data_exclusion_40[:,6],
          ...
          sem(np.mean([data_exclusion_70[:,6],
                       data_exclusion_70[:,7]], axis=0))]
D_theory = mean_n2[1] * (vis_measured[1]/vis_range)
...
D_theory_n1 = mean_n1[1] * (vis_measured[1]/vis_range)
D_theory_n2 = mean_n2[1] * (vis_measured[1]/vis_range)
...
D_theory_CO = mean_CO[1] * (vis_measured[1]/vis_range)
