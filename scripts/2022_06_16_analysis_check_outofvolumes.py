...
whichFiles = 87
imgs_thresh = tifffile.imread(thresholdFiles[whichFiles])#[inframe:inframe+190]
imgs = tifffile.imread(intensityFiles[whichFiles])#[inframe:inframe+190]
...
print(whichFiles, individual_data["data_name"])
