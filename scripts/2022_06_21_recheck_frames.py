...
whichFiles = 33; stframe = 140
imgs_thresh = tifffile.imread(thresholdFiles[whichFiles])[stframe:stframe+160]
imgs = tifffile.imread(intensityFiles[whichFiles])[stframe:stframe+160]
